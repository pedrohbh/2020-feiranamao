...
@Component({
  ...
  template: `<table>
			...
			</table><td id="produto.id">{{ produto.id }}</td><td id="produto.name">{{ produto.name }}</td><td id="produto.preco">{{ produto.preco }}</td><td id="produto.estoque">{{ produto.estoque }}</td><td id="produto.categoria.name">{{ produto.categoria.name }}</td>
